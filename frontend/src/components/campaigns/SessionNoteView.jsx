  ...
  return (
    <div style={{ marginBottom: 4 }}>
      ...
      >
        ...
        {lastSaved && (
          <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>{t('sessionNote.saved')}</span>
        )}
      </div>
      <textarea
        ...
        {editingTitle ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            ...
            <button
              ...
              aria-label={t('sessionNote.cancelTitle')}
              style={iconBtn}
            >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <span aria-live="polite" aria-atomic="true">
              {savingPlayer && (
                <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>
                  {t('sessionNote.saving')}
                </span>
              )}
              {savedPlayer && (
                <span style={{ fontSize: 11, color: 'var(--gold)' }}>{t('sessionNote.saved')}</span>
              )}
            </span>
          </div>
          <NoteEditor
        ...
        {otherPlayerNotes.map((n) => (
          ...
          >
            ...
            >
              <LuUser size={14} />{' '}
              {t('sessionNote.playersNotes', { name: n.display_name || n.username })}
            </div>
            <NoteEditor
              label=""
              value={n.content || ''}
