      ...
      >
        ...
        >
          ...
          {token.pixel_width != null && (
            <MetaRow
              label={t('tokens.detail.resolution')}
              value={t('tokens.detail.resolutionValue', {
                width: token.pixel_width,
                height: token.pixel_height,
              })}
            />
          )}
